...
const translations = {
  en: {
    ...
    // Product Page - Gavion Triple Torsion
    page_gavion_title: "Triple Twist Gabion",
    page_gavion_subtitle: "Effective modular solution to stabilize terrain, prevent erosion and create durable geotechnical and hydraulic structures.",
    page_gavion_desc_title: "Product Description",
    page_gavion_desc1: "Triple twist gabions are modular wire mesh containers filled with appropriately sized stones to create solid and durable structures. This solution combines structural flexibility with high mechanical resistance.",
    page_gavion_desc2: "Ideal for geotechnical and hydraulic applications, our gabions offer a lifespan exceeding 100 years thanks to their PVC coating and the quality of steel used in manufacturing.",
    page_gavion_specs_title: "Technical Specifications",
    spec_property: "Property",
    spec_value: "Value",
    spec_standard_size: "Standard Size",
    spec_wire_gauge: "Wire Gauges",
    spec_mesh_opening: "Mesh Opening",
    spec_coating: "Coating",
    spec_coating_value: "Galvanized + PVC (optional)",
    spec_lifespan: "Lifespan",
    spec_lifespan_value: "100+ years",
    spec_certifications: "Certifications",
    page_gavion_features_subtitle: "Advantages",
    page_gavion_features_title: "Key Features",
    feat_flexible_title: "Flexible Structure",
    feat_flexible_desc: "Resistant to unforeseen stresses without losing functionality, adapting to terrain.",
    feat_drainage_title: "High Permeability",
    feat_drainage_desc: "Allows natural drainage preventing hydrostatic pressure buildup.",
    feat_corrosion_title: "Corrosion Resistance",
    feat_corrosion_desc: "Steel with protective coating and PVC options for greater durability.",
    feat_impact_title: "Impact Resistance",
    feat_impact_desc: "Stone-filled design absorbs terrain movements and impacts.",
    feat_install_title: "Easy Installation",
    feat_install_desc: "No specialized labor required. Manual or mechanical assembly.",
    feat_cost_title: "Cost-Effective",
    feat_cost_desc: "More economical than concrete alternatives with equal or greater durability.",
    page_gavion_apps_subtitle: "Uses",
    page_gavion_apps_title: "Applications",
    app_slopes: "Slope Stabilization",
    app_slopes_desc: "Geotechnical control of slopes and hillsides.",
    app_rivers: "Fluvial Containment",
    app_rivers_desc: "Protection of riverbanks and watercourses.",
    app_bridges: "Bridge Support",
    app_bridges_desc: "Protection and reinforcement of road infrastructure.",
    app_canals: "Irrigation Canals",
    app_canals_desc: "Lining and protection of irrigation systems.",
    app_coastal: "Coastal Structures",
    app_coastal_desc: "Marine and port protection.",
    app_emergency: "Emergency Response",
    app_emergency_desc: "Rapid solutions for natural disasters.",
    app_erosion: "Erosion Control",
    app_erosion_desc: "Prevention of soil loss.",
    app_landscape: "Landscaping",
    app_landscape_desc: "Aesthetic integration with natural surroundings.",
    page_gavion_cta_title: "Need Gabions for Your Project?",
    page_gavion_cta_desc: "Our team of experts is ready to advise you and provide a personalized quote.",
  },
  ...
  es: {
    ...
    // Product Page - Gavion Triple Torsion
    page_gavion_title: "Gavión Triple Torsión",
    page_gavion_subtitle: "Solución modular efectiva para estabilizar terrenos, prevenir la erosión y crear estructuras geotécnicas e hidráulicas duraderas.",
    page_gavion_desc_title: "Descripción del Producto",
    page_gavion_desc1: "Los gaviones de triple torsión son contenedores modulares de malla metálica que se rellenan con piedras de tamaño apropiado para crear estructuras sólidas y duraderas. Esta solución combina flexibilidad estructural con alta resistencia mecánica.",
    page_gavion_desc2: "Ideales para aplicaciones geotécnicas e hidráulicas, nuestros gaviones ofrecen una vida útil superior a 100 años gracias a su recubrimiento de PVC y la calidad del acero utilizado en su fabricación.",
    page_gavion_specs_title: "Especificaciones Técnicas",
    spec_property: "Propiedad",
    spec_value: "Valor",
    spec_standard_size: "Tamaño Estándar",
    spec_wire_gauge: "Calibres de Alambre",
    spec_mesh_opening: "Abertura de Malla",
    spec_coating: "Recubrimiento",
    spec_coating_value: "Galvanizado + PVC (opcional)",
    spec_lifespan: "Vida Útil",
    spec_lifespan_value: "100+ años",
    spec_certifications: "Certificaciones",
    page_gavion_features_subtitle: "Ventajas",
    page_gavion_features_title: "Características Principales",
    feat_flexible_title: "Estructura Flexible",
    feat_flexible_desc: "Resistente a esfuerzos imprevistos sin perder funcionalidad, adaptándose al terreno.",
    feat_drainage_title: "Alta Permeabilidad",
    feat_drainage_desc: "Permite el drenaje natural evitando acumulación de presión hidrostática.",
    feat_corrosion_title: "Resistencia a Corrosión",
    feat_corrosion_desc: "Acero con recubrimiento protector y opciones con PVC para mayor durabilidad.",
    feat_impact_title: "Resistencia a Impactos",
    feat_impact_desc: "El diseño con piedras absorbe movimientos e impactos del terreno.",
    feat_install_title: "Fácil Instalación",
    feat_install_desc: "No requiere mano de obra especializada. Montaje manual o mecánico.",
    feat_cost_title: "Económico",
    feat_cost_desc: "Más económico que alternativas de concreto con igual o mayor durabilidad.",
    page_gavion_apps_subtitle: "Usos",
    page_gavion_apps_title: "Aplicaciones",
    app_slopes: "Estabilización de Taludes",
    app_slopes_desc: "Control geotécnico de pendientes y laderas.",
    app_rivers: "Contención Fluvial",
    app_rivers_desc: "Protección de riberas y cauces de ríos.",
    app_bridges: "Soporte de Puentes",
    app_bridges_desc: "Protección y refuerzo de infraestructura vial.",
    app_canals: "Canales de Riego",
    app_canals_desc: "Revestimiento y protección de sistemas de irrigación.",
    app_coastal: "Estructuras Costeras",
    app_coastal_desc: "Protección marina y portuaria.",
    app_emergency: "Respuesta de Emergencia",
    app_emergency_desc: "Soluciones rápidas ante desastres naturales.",
    app_erosion: "Control de Erosión",
    app_erosion_desc: "Prevención de pérdida de suelo.",
    app_landscape: "Paisajismo",
    app_landscape_desc: "Integración estética con el entorno natural.",
    page_gavion_cta_title: "¿Necesita Gaviones para su Proyecto?",
    page_gavion_cta_desc: "Nuestro equipo de expertos está listo para asesorarlo y proporcionarle una cotización personalizada.",
  }
};
